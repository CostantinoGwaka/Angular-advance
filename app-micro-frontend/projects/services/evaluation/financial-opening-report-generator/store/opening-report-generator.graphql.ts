...
export const REFRESH_REIMBURSEMENT_EXPENSE_DECRYPTION = gql`
  mutation refreshReimbursementExpenseDecryption($submissionUuid: String) {
    refreshReimbursementExpenseDecryption(submissionUuid: $submissionUuid) {
      message
      code
      status
      data
