...
@Component({
    ...
    standalone: true,
    imports: [MatInputModule, NgClass, MatButtonModule, MatIconModule]
})
export class MatSelectSearchComponent implements OnInit, OnDestroy, AfterViewInit, ControlValueAccessor {
  ...
  constructor(@Inject(MatSelect) public matSelect: any,
  ...
  ngOnInit() {
    ...
    const panelClass: string = 'mat-select-search-panel' as string;;
   ...
   * Note: to improve this code, mat-select should be extended to allow disabling resetting the selection-proccess while filtering.
   */
      ...
      .subscribe((values: any) => {
        if (this.matSelect.multiple) {
          ...
          if (this._value && this._value.length
            ...
            const optionValues = this.matSelect.options.map((option: any) => option.value);
