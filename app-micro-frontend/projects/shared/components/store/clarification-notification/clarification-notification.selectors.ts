...
import * as fromReducer from './clarification-notification.reducer';
import { getSharedState } from '../../../store/shared.reducer';

export const selectCurrentState = createSelector(getSharedState, (state) => state.clarificationNotification);
...
export const selectAllClarificationNotification = createSelector(selectCurrentState, fromReducer.selectAll);
