...
import * as fromReducer from './government-service-notification.reducer';
import { getSharedState } from '../../../store/shared.reducer';

export const selectCurrentState = createSelector(getSharedState, (state) => state.governmentServiceNotification);
...
export const selectAlLGovernmentServiceNotifications = createSelector(selectCurrentState, fromReducer.selectAll);
