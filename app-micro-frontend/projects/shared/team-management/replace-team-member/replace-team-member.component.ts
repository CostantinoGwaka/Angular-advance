...
import { REPLACE_EVALUATION_COMMITTE } from 'src/app/modules/nest-tender-evaluation/store/evaluation-commitee/evaluation-commitee.graphql';
...
@Component({
  selector: 'app-replace-team-member',
...
export class ReplaceTeamMemberComponent implements OnInit {
